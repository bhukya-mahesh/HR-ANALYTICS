...
Project workflow diagram: [draw.io/hr_analytics_project_flow.drawio](draw.io/hr_analytics_project_flow.drawio)
...
│   ├── hr_analytics_table.png            # Detailed table view image
│   └── images-used-in-dashboard-creation/
│       └── ChatGPT generated dashboard supporting visuals
│
├── 📂 python/
